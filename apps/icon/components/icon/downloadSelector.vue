        ...
        .options
          ...
          .size
            .unlock-svg(v-if="!isAvailable({format: currentFormat})")
              ...
              a.button.is-tiny(v-on:click="seePricing") See pricing
              br
              a.login(v-on:click="login") Login
...
<script>
  ...
  import colorLock from '../../../public/assets/svg/colorLock.svg'
  ...
  export default {
    ...
    methods: {
      ...
      seePricing () {
        ...
        window.location.href = config.backendUrl + '/paid-license-99'
      }
    }
  }
</script>
