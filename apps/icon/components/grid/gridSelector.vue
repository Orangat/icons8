...
<script>
  import icons from '../../../public/assets/svg/grid/icons.svg'
  import labels from '../../../public/assets/svg/grid/labels.svg'
  import grid from '../../../public/assets/svg/grid/grid.svg'
    ...
    methods: {
      ...
      itemClass (style) {
        return {
          ...
          'is-disabled': !this.isEnabled(style)
        }
      }
    }
  }
